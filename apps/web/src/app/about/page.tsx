...
export default function AboutPage() {
  return (
    <Container className="max-w-3xl space-y-6 py-10 text-slate-700">
      ...
      <p>
        FastTravel — український <strong>інформаційний агрегатор</strong> турів.
        Ми збираємо публічно доступні ціни на тури у популярні напрямки
        (наразі — Туреччина) у єдиному календарі і показуємо їх безкоштовно.
      </p>

      <section>
        <h2 className="mb-2 text-xl font-semibold text-slate-900">Що ми робимо</h2>
        <ul className="list-inside list-disc space-y-1">
          <li>Збираємо ціни двічі на день із трьох туроператорів.</li>
      ...
      <section>
        ...
        <ul className="list-inside list-disc space-y-1">
          <li>
            <strong>Ми не туроператор</strong> і не маємо ліцензії на турдіяльність —
            її і не потребуємо, бо не продаємо тури.
          </li>
      ...
      <section>
        ...
        <p>
          Ціни постачаються через офіційні API-партнерства з агрегаторами
          (ittour.com.ua) та публічно доступний контент про готелі. Якщо ви
          туроператор і хочете бути у нашому каталозі — напишіть на{' '}
          <a
            href="mailto:partners@fasttravel.com.ua"
      ...
      <p className="border-l-4 border-slate-200 pl-4 text-sm text-slate-500">
        Дисклеймер: ціни на сайті можуть відрізнятись від актуальних на сайті
        оператора через затримку оновлення (до 12 годин). Завжди перевіряйте
        фінальну вартість на стороні туроператора перед оплатою.
      </p>
    </Container>
  );
}
